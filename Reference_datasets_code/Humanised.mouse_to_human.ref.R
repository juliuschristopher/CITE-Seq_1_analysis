## ##Query humanised mouse to human reference datasets####
library(SeuratDisk)
library(anndata)
...
setwd("~/Desktop/Reference_Datasets/Humansied.Mouse_to_mouse")

####Query - Humanised mouse (upper case gene names) to mouse (lower case gene name)####
